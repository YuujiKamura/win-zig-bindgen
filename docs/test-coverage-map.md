...
| 107 | rustfmt_25 | POINT --rustfmt max_width=25 | PASS | manifest等価 |

## サマリー (2026-03-08)

**`zig build test-red` 結果: 104/107 passed, 3 failed**
...
| Level | 内容 | 現在のカバレッジ |
|-------|------|-----------------|
| Level 1 | WinMDから型/メソッド/フィールドが正しく読めるか | 104/107 |
